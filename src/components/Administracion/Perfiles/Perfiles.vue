                                    ...
                                    <v-card-text>
                                        <v-container>
                                                <v-row>
                                                    ...
                                                    <v-col cols="12" sm="6">
                                                        <v-select v-model="registro.grupo_id" :disabled="loading" :items="grupos" label="Grupo" item-text="nombre" item-value="id"></v-select>
                                                    </v-col>
...
export default {
    ...
    mounted() {
        if (!this.permiso('OP_ADM_PERFILES')) {
            this.$router.push('/')
        } else {
            this.init();
        }
    ...
    methods:{
        ...mapActions({
            fetchLista: 'perfiles/fetchListado',
            fetchListaGrupos: 'perfiles/fetchListadoGrupos',
            saveRecord: 'perfiles/saveRecord',
            updateRecord: 'perfiles/updateRecord',
            delete: 'perfiles/deleteRecord',
        }),
        ...mapMutations({
            setInfo: 'setInfo',
        }),
    ...
    computed: {
        ...mapState({
            lista: state => state.perfiles.lista,
            pagination: state => state.perfiles.pagination,
