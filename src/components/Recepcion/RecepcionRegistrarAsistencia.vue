                ...
                this.listarEstados()
                    .then(result => {
                        ...
                        if (this.estados && this.estados.llamadas) {
                            ...
                            && ((this.lead && this.lead.estado && ['agendar_cita','agendar_cita_virtual'].includes(this.lead.estado)) || (this.lead && this.lead.ultima_llamada && ['agendar_cita','agendar_cita_virtual'].includes(this.lead.ultima_llamada.resolucion)) || (this.lead && this.lead.af_ultima_llamada && ['agendar_cita','agendar_cita_virtual'].includes(this.lead.af_ultima_llamada.resolucion)))) {
